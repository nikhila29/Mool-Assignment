...
const StyledCoinsStacked04 = styled.svg`
  .path {
...
export const CoinsStacked04 = ({ color = "black", className }) => {
  return (
    <StyledCoinsStacked04
      className={`coins-stacked-04 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
